...
struct PostItem: View {
    ...
    var body: some View {
        VStack {
            ...
            PostFooter(post: post, shareText: "User @\(post.postedBy.username) posted this Amazing Setup in United Setups, check it out.", postIdLoading: postIdLoading, likePost: likePost, inComments: inComments)
        }
        .padding()
